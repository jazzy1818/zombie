...
Run: 2026-09-13T11:13:52.601Z

Browser: 141.0.7390.122

Unpacked extension: ngmbkfbiloiaccjjbkhcenpegojlmjng
...
- PASS: A confident local match never consults the bridge's model
- PASS: The bridge's model ruling a lesson out still leaves the near miss on offer
- PASS: The bridge's model can pick a lesson: offered alone, never launched unasked, with a way out on its preamble
- PASS: An older bridge without /match falls back to the local shortlist
